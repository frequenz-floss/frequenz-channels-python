...
[`ChannelError`][] exception. When there is an attempt to
use a closed channel, a [`ChannelClosedError`][]
exception is raised.
...
Tip:
    ...
    [`ReceiverStoppedError`][] exception by
    explicitly calling [`receive()`][] on the
