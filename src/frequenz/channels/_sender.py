...
[`Sender`][frequenz.channels.Sender] objects. [`Sender`][frequenz.channels.Sender]s are
...
class SenderError(Error, Generic[SenderMessageT_co]):
    ...
    def __init__(self, message: str, sender: Sender[SenderMessageT_co]):
        ...
        """The [`Sender`][frequenz.channels.Sender] where the error happened."""
...
class SubscribableSender(Sender[SenderMessageT_contra], ABC):
    ...
    def subscribe(self) -> Receiver[SenderMessageT_contra]:
        ...
        Returns:
            A new [`Receiver`][frequenz.channels.Receiver] attached to this sender's channel.
        """
