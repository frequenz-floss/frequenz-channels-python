...
async def select(*receivers: Receiver[Any]) -> AsyncIterator[Selected[Any]]:
    ...
    Note:
        ...
        * Use [`Merge`][frequenz.channels.merge.Merge] or
          [`MergeNamed`][frequenz.channels.merge_named.MergeNamed]: this is useful when
          you have and unknown number of receivers of the same type that can be handled
          as a group.
